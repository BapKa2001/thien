...
local Vehicles = {
    ...
    --- Super (7)
    { model = 'oycinv',        name = 'LAMBOGINI 1',                   brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'I8',            name = 'BMW I8',                        brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'gt63s19',       name = 'mẹt',                           brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'koen',          name = 'koen',                          brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'sennas',        name = 'sennas',                        brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'sl63amg22',     name = 'MẸT 2 CHỗ',                     brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'bmwrad',        name = 'BMW ĐỘ SÂN',                    brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'polestar1',     name = 'polestar1',                     brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'urusperf23',    name = 'laboghini 2',                   brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    --- Motorcycles (8)
    { model = 'mvso',          name = 'CBR 600SP',                     brand = 'Dinka',           price = 515000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'yr1',           name = 'yr1',                           brand = 'Dinka',           price = 552000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'rc',            name = 'KTM',                           brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'sh150',         name = 'sh150',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'd99',           name = 'Ducati',                        brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'offlrds1000r',  name = 'S1000rr độ',                    brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'r1',            name = 'r1',                            brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 's1000rr',       name = 's1000rr',                       brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'hcbr17',        name = 'CBR 650',                       brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'ems_gs1200',    name = 'MoTo POLICE',                   brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'dmons',         name = 'DCATI SP',                      brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'zx10r',         name = 'zx10r',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'yzfr6',         name = 'YAMAHA R6',                     brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'nh2r',          name = 'NINJA H2',                      brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'libertys',      name = 'Tay GA',                        brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'cbr1000rrr',    name = 'CBR 1000rrr',                   brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'bmws1000rr',    name = 'Cá Mập Mắt Lé',                 brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    ...
    --- Vans (12)
    { model = 'forsan',        name = 'xe tải',                        brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    ...
    --- Emergency (18)
    { model = 'policebvn',     name = 'policebvn',                     brand = 'Brute',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'polgs350',      name = 'polgs350',                      brand = 'Brute',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'polcaracara',   name = 'polcaracara',                   brand = 'Brute',           price = 100000,  category = 'emergency',      type = 'automobile', shop = 'none' },
