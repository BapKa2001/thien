...
local Vehicles = {
    ...
    --- Super (7)
    { model = 'I8',            name = 'I8',                            brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'gt63s19',       name = 'gt63s19',                       brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    { model = 'sl63amg22',     name = 'sl63amg22',                     brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'bmwrad',        name = 'bmwrad',                        brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'polestar1',     name = 'polestar1',                     brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'urusperf23',    name = 'urusperf23',                    brand = 'Truffade',        price = 280000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    --- Motorcycles (8)
    { model = 'offlrds1000r',  name = 'offlrds1000r',                  brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    ...
    { model = 'hcbr17',        name = 'hcbr17',                        brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'ems_gs1200',    name = 'ems_gs1200',                    brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'dmons',         name = 'dmons',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'zx10r',         name = 'zx10r',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'yzfr6',         name = 'yzfr6',                         brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'nh2r',          name = 'nh2r',                          brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'libertys',      name = 'libertys',                      brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'cbr1000rrr',    name = 'cbr1000rrr',                    brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'bmws1000rr',    name = 'bmws1000rr',                    brand = 'Dinka',           price = 55000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
